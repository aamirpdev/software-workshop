...
const getHostResponseTime = require('../controllers/user/getHostResponseTime');
...
const getOpportunities = require('../controllers/organisation/getOpportunities');
const getSingleOpportunity = require('../controllers/organisation/getSingleOpportunity');
const {
  internDashboard,
  hostDashboard,
  orgDashboard,
...
// gets hosts responseTime (authenticated user)
router.get(HOST_RESPONSE_TIME_URL, authentication, getHostResponseTime);
...
router.post(ADMIN_ADD_FUNDS_URL, authentication, adminAddFunds);
...
router.get(REVIEW_BY_BOOKING, getReviewByBooking);
