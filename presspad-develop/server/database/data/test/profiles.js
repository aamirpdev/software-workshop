...
const hostProfileData = {
  ...
  lastStudyUniversity: 'London Univ',
  bio:
...
const internProfileData = {
  ...
  gender: types.gender[1], // male
  hometown: 'Manchester',
  lastStudyUniversity: 'Manchester Univ',
  bio:
...
const createAll = async ({ users }) => {
  ...
  const intern4 = { ...internProfileData, user: internUser4 };
  const [
    hostProfile,
    host2Profile,
    internProfile,
    ...
    internProfile3,
    internProfile4,
  ] = await Profile.create([host, host2, intern, intern2, intern3, intern4]);
