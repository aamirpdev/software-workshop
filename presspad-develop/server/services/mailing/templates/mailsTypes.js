...
const types = {
  host: {
    ...
    // not implemented yet replaced by before/after payment
    ...
    BOOKING_CONFIRMED_NO_PAYMENT: {
      createBody: host.bookingConfirmedNoPayment,
      subject: 'Booking confirmed',
      params: [],
    },
    // done
    BOOKING_CONFIRMED_AFTER_PAYMENT: {
      createBody: host.bookingConfirmedAfterPayment,
      subject: 'Booking confirmed!',
      params: ['internName', 'bookingId'],
    },
    // done
  ...
  intern: {
    ...
    BOOKING_CONFIRMED_NO_PAYMENT: {
      createBody: intern.bookingConfirmedNoPayment,
      subject: 'Booking confirmed!',
      params: [],
    },
    BOOKING_CONFIRMED_AFTER_PAYMENT: {
      createBody: intern.bookingConfirmedAfterPayment,
      subject: 'Booking confirmed!',
      params: ['hostName', 'bookingId'],
    },
    // not implemented yet replaced by before/after payment
    ...
    // done
    BOOKING_CANCELED: {
      createBody: intern.bookingCancelled, // automated cancellation
      subject: 'Booking cancellation',
      params: [],
    },
    // not implemented yet replaced by before/after payment
