...
const sendProfileReminderEmail = require('./sendProfileReminderEmail');
const bookingCompleted = require('./bookingCompleted');
const bookingConfirmedAfterPayment = require('./bookingConfirmedAfterPayment');
const bookingConfirmedNoPayment = require('./bookingConfirmedNoPayment');
...
module.exports = {
  ...
  bookingCompleted,
  bookingConfirmedAfterPayment,
  bookingConfirmedNoPayment,
};
