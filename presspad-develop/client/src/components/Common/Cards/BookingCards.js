  ...
  return (
    ...
    >
      <S.LeftDiv type={type}>
        <S.LeftTop type={type}>
          <S.LeftTopContent>
            ...
            <DateMonth style={{ color: 'white' }}>
              {startMonth} {formatYear(startYear)}
            </DateMonth>
          </S.LeftTopContent>
          <S.LeftTopContent>
            <DatesRange
          ...
          <S.LeftTopContent>
            ...
            <DateMonth style={{ color: 'white' }}>
              {`${endMonth.concat(' ').concat(formatYear(endYear))}`}
            </DateMonth>
          </S.LeftTopContent>
        </S.LeftTop>
        {type === 'big' ? (
      ...
      <S.RightDiv type={type}>
        {type === 'big' && (
          <S.SubTitle style={{ color: theme.colors.gray }}>
            {withUserType}
          </S.SubTitle>
        )}
