...
export const ContentWrapper = styled.div`
  ...
  width: 100%;
  padding: ${({ theme }) =>
    `${theme.spacings.sideMenuLayout.mobileTop} 3% ${theme.spacings.sideMenuLayout.bottom}`};

  @media ${breakpoints.mobileL} {
    padding: ${({ theme }) =>
      `${theme.spacings.sideMenuLayout.mobileTop} 7% ${theme.spacings.sideMenuLayout.bottom}`};
  }

  @media ${breakpoints.tablet} {
    padding: ${({ theme }) =>
      `${theme.spacings.sideMenuLayout.mobileTop} 4% ${theme.spacings.sideMenuLayout.bottom}`};
  }
