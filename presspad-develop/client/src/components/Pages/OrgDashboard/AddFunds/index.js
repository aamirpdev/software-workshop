...
function AddFunds({ stripe, elements, signUp }) {
  ...
  return (
    <>
      ...
      <Row>
        <Col w={[4, 12, 12]}>
          <T.H5 color={signUp ? 'pink' : 'blue'} mb={2}>
            Add Funds
          </T.H5>
        </Col>
      </Row>
      <Row mb="5">
        <Col w={[4, 12, 12]}>
          <T.P>
            If you would like to pay via an invoice instead of card please
            contact us at{' '}
            <a href="mailto:info@presspad.co.uk">info@presspad.co.uk</a>
          </T.P>
        </Col>
      </Row>
