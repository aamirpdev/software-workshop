      ...
      <Switch>
        ...
        {role === 'admin' && (
          <Route
            isPrivate
            exact
            path={ADMIN_SINGLE_INTERNS_URL}
            type="success"
            Component={AdminSingleIntern}
            handleChangeState={handleChangeState}
            isLoggedIn={isLoggedIn}
            layout="sideMenu"
            {...props}
        ...
        {role === 'admin' && (
          <Route
            isPrivate
            exact
            path={ADMIN_SINGLE_HOSTS_URL}
            type="success"
            Component={AdminSingleHost}
            handleChangeState={handleChangeState}
            isLoggedIn={isLoggedIn}
            layout="sideMenu"
            {...props}
