  ...
  const onSave = async isContinue => {
    ...
    try {
      ...
      if (!_errors) {
        ...
        setErrors(_errors);
        setMainError('Please review highlighted profile issues');
      }
  ...
  return (
    <div>
      ...
      <Row mb={6}>
        <Col w={[4, 12, 10.8]}>
          <Input
            ...
            label="Description"
            name="description"
            helperText="Provide a short bio for your organisation (No more than 250 words)"
      ...
      <Row mb={6}>
        <Col w={[4, 12, 10.8]}>
          <T.P color="gray">
            Is there a main point of contact or email address applicants should
