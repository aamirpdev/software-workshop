...
export const OPPORTUNITY_URL = '/opportunities/:id';
// editing details
...
export const ADMIN_SINGLE_INTERNS_URL = `${ADMIN_INTERNS_URL}/:id`;
export const ADMIN_HOSTS_URL = '/admin/hosts';
export const ADMIN_SINGLE_HOSTS_URL = `${ADMIN_HOSTS_URL}/:id`;
export const ADMIN_ORGS_URL = '/admin/clients';
export const ADMIN_SINGLE_ORG_URL = `${ADMIN_ORGS_URL}/:id`;
