...
const HOST_RESPONSE_TIME_URL = '/host/:id/response-time';
const API_HOST_RESPONSE_TIME_URL = `${API_PREFIX}${HOST_RESPONSE_TIME_URL}`;
...
const ADMIN_SINGLE_CLIENT = '/admin/client/:id';
const API_ADMIN_SINGLE_CLIENT = `${API_PREFIX}${ADMIN_SINGLE_CLIENT}`;
...
const ORG_DETAILS = '/organisation/:id';
const API_ORG_DETAILS = `${API_PREFIX}${ORG_DETAILS}`;

const OPPORTUNITIES_URL = '/opportunities';
const API_OPPORTUNITIES_URL = `${API_PREFIX}${OPPORTUNITIES_URL}`;

const SINGLE_OPPORTUNITY_URL = '/opportunities/:id';
const API_SINGLE_OPPORTUNITY_URL = `${API_PREFIX}${SINGLE_OPPORTUNITY_URL}`;
...
const REVIEW_BY_BOOKING = '/booking/:id/reviews';
const API_REVIEW_BY_BOOKING = `${API_PREFIX}${REVIEW_BY_BOOKING}`;
...
const GET_INTERN_BURSARY_APPLICATION = '/bursary/:id';
const API_GET_INTERN_BURSARY_APPLICATION = `${API_PREFIX}${GET_INTERN_BURSARY_APPLICATION}`;
...
const HOST_SETTINGS_ABOUT_ME = '/settings/host/about-me';
const API_HOST_SETTINGS_ABOUT_ME = `${API_PREFIX}${HOST_SETTINGS_ABOUT_ME}`;

const HOST_SETTINGS_MY_LISTING = '/settings/host/my-listing';
const API_HOST_SETTINGS_MY_LISTING = `${API_PREFIX}${HOST_SETTINGS_MY_LISTING}`;

const HOST_SETTINGS_VERIFICATIONS = '/settings/host/verifications';
const API_HOST_SETTINGS_VERIFICATIONS = `${API_PREFIX}${HOST_SETTINGS_VERIFICATIONS}`;
...
const ADMIN_ADD_FUNDS_URL = '/admin/add-funds';
const API_ADMIN_ADD_FUNDS_URL = `${API_PREFIX}${ADMIN_ADD_FUNDS_URL}`;

const ADMIN_SINGLE_HOST = '/admin/hosts/:id';
const API_ADMIN_SINGLE_HOST = `${API_PREFIX}${ADMIN_SINGLE_HOST}`;

const ADMIN_SINGLE_INTERN = '/admin/interns/:id';
const API_ADMIN_SINGLE_INTERN = `${API_PREFIX}${ADMIN_SINGLE_INTERN}`;
...
module.exports = {
  ...
  API_ADMIN_SINGLE_HOST,
  API_ADMIN_SINGLE_INTERN,
